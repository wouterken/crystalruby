...
module CrystalRuby
  ...
  class Function
    ...
    attr_accessor :original_method, :owner, :args, :returns, :function_body,
    ...
    def define_crystalized_methods!(lib)
      ...
      receivers.each do |receiver|
        ...
        receiver.define_method(name) do |*args, &blk|
          ...
          args = func.map_args(blk ? args + [blk] : args)
          args.unshift(self.memory) if func.instance_method
    ...
    def register_callback!
      ...
      Reactor.schedule_work!(lib, :"register_#{name}_callback", @callback_func, :void, blocking: true, async: false)
    end
    ...
    def lib_fn_arg_names(skip_blocks = false)
      @lib_fn_arg_names ||= begin
        ...
        names.unshift("self.address") if instance_method
    ...
    def unmap_retval(retval)
      ...
      return_type_map[:arg_mapper][retval]
    end
